...
struct DivisionView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
            QuestionPresentationView(operation: "÷", firstValue: divisor, secondValue: divisor)
            ...
            ZStack {
                ...
                CheckAnswerButtonView(answerChecked: $answerChecked, answerCorrect: $answerCorrect, inputGiven: inputGiven, correctSolution: correctQuotient)
